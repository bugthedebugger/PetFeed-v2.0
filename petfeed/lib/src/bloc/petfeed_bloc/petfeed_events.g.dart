...
class _$LogOutSuccess extends LogOutSuccess {
  factory _$LogOutSuccess([void Function(LogOutSuccessBuilder) updates]) =>
      (new LogOutSuccessBuilder()..update(updates)).build();

  _$LogOutSuccess._() : super._();

  @override
  LogOutSuccess rebuild(void Function(LogOutSuccessBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  LogOutSuccessBuilder toBuilder() => new LogOutSuccessBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LogOutSuccess;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('LogOutSuccess').toString();
  }
}

class LogOutSuccessBuilder
    implements Builder<LogOutSuccess, LogOutSuccessBuilder> {
  _$LogOutSuccess _$v;

  LogOutSuccessBuilder();

  @override
  void replace(LogOutSuccess other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$LogOutSuccess;
  }

  @override
  void update(void Function(LogOutSuccessBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$LogOutSuccess build() {
    final _$result = _$v ?? new _$LogOutSuccess._();
    replace(_$result);
    return _$result;
  }
}
